...
import SiwarPP from "@/assets/siwar-pp.png";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-[50px] sm:gap-[40px] z-[50]">
        ...
        {/* Fully circular photo */}
        <CardContainer className="hidden inter-var md:block">
          <CardBody className="hidden sm:flex items-center justify-center bg-transparent dark:bg-transparent border-0 w-auto h-auto rounded-full p-0 mx-auto">
            <CardItem translateZ="100" className="flex justify-center">
              <div className="relative sm:w-32 md:w-48 xl:w-72 sm:h-32 md:h-48 xl:h-72 rounded-full overflow-hidden border-4 border-fuchsia-500/30 group-hover/card:shadow-xl">
                <Image
                  src={SiwarPP}
                  fill
...
const HeroButton = ({ href, text, icon, download }: { href: string; text: string; icon: React.ReactNode; download?: boolean }) => (
  ...
  >
    ...
    <div className="text-white dark:text-black">{text}</div>
  </a>
);

const ResumeSvg = () => (
  <svg className="text-white dark:text-black" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const GithubSvg = () => (
  <svg className="w-5 h-5 text-white dark:text-black" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
...
const LinkedinSvg = () => (
  <svg className="text-[#57a6f4] dark:text-[#0A66C2]" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
